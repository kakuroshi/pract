...
const Cart = () => {
    ...
    const updateCount = (sign, id) => {
        const newProducts = products.map(el => {

            console.log(id);
            
            if (el.count === 1 && sign === false) {
                alert("Нельзя")
                return el
            }
                    ...
                    <div className="card-cart-for-order" >
                        ...
                        <div className="info-product-cart" >
                            ...
                            <div className="info-title-product-cart">
                                ...
                                <p className="article-cart-product">{el.id}</p>
                            </div>
                            ...
                            <div className="plus-minus-btns-products">
                                ...
                                onClick={() => updateCount(false, el.id)}>
                                ...
                                onClick={() => updateCount(true, el.id)}>
                            ...
                            <div className="buttons-footer-product">
                                <div className="favorite-card-cart">
                        ...
                        <div className="cost-div-cart">
                            ...
                            <h1 className="cost-price-cart">{el.price}</h1>
